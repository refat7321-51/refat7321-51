...
class Refat:
    ...
    learning = ["Python", "Django", "Cybersecurity"]
    focus    = "Building real-world projects, not just theory"
    motto    = "Consistency over motivation. Skill over excuses."
    goal     = "Professional Backend-Focused Web Developer"
```

I am a **Computer Science & Technology diploma student** with a strong focus on web development. I am currently building my skills in **Python** and **Django** to develop scalable and functional web applications.

I don't just learn theory — I focus on **building real projects** and improving my practical problem-solving skills. I have already worked on basic web projects using HTML, CSS, and Django, and I am continuously pushing myself to level up.

My goal is to become a **professional backend-focused web developer**, with strong knowledge in Django and modern web technologies. I am also exploring **cybersecurity** as a parallel interest to strengthen my technical foundation.

> 💜 *"I believe in consistency over motivation and skill over excuses. Every day, I try to improve — even if it's a small step."*
...
[![Portfolio](https://img.shields.io/badge/Portfolio-A855F7?style=for-the-badge&logo=google-chrome&logoColor=white)](https://refat7321-51.github.io/My-Website/)
